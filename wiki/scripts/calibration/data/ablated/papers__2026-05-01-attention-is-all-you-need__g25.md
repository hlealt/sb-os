<!-- SILVER-ABLATION FIXTURE -- DO NOT INGEST. grade=0.25 deleted=12 from=3-resources/knowledge-base/wiki/sources/papers/2026-05-01-attention-is-all-you-need.md schema=silver-ablation/1 -->
---
type: source
created: 2026-05-25
...
- **Task / data:** WMT 2014 English-German (~4.5M sentence pairs, ~37K shared byte-pair vocabulary) and the larger WMT 2014 English-French (36M sentences, 32K word-piece vocabulary); batches grouped by approximate sequence length (~25K source +  target tokens each).[^1]
...
-  vary attention heads, key/value dimensions, model depth/width, dropout, and positional encoding; single-head attention is 0.9 BLEU worse than the best head count, and too many heads also degrades quality.[^1]
