<!-- SILVER-ABLATION FIXTURE -- DO NOT INGEST. grade=0.25 deleted=21 from=3-resources/knowledge-base/wiki/sources/papers/2026-05-07-the-rising-costs-of-training-frontier-ai-models.md schema=silver-ablation/1 -->
---
type: source
created: 2026-05-25
...
- The most expensive publicly announced runs to date are [[openai.md]]'s  at $40M amortized and 's [[gemini-models.md|Gemini Ultra]] at $30M amortized; extrapolating the 2.4x trend implies a ~$1 billion training run by the start of 2027.[^1]
- A third, deeper approach for four models ([[gpt-3.md]], [[opt-175b.md]], [[gpt-.md]], ) adds R&D staff costs over the whole development process (experiments, evaluation, fine-tuning): R&D staff are 29–% of total cost with equity included, 19–33% excluding equity; computing hardware is 47–64%, energy 2–6%.[^1]
...
-  Total annual compensation sampled from log-normal distributions (base salary 90% CI $140K–$160K, equity $35K–$490K, 1.25–1.4x overhead), informed by levels.fyi and aipaygrad.es; FTE workload per contributor sampled at a median ~20%.[^1]
-  No public sale prices exist, so  cost is the geometric mean of a bill-of-materials low estimate and an equivalent-GPU-price high estimate (~$5,000 per TPU across versions).[^1]
