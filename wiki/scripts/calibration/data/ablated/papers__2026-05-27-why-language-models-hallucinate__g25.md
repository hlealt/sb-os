<!-- SILVER-ABLATION FIXTURE -- DO NOT INGEST. grade=0.25 deleted=11 from=3-resources/knowledge-base/wiki/sources/papers/2026-05-27-why-language-models-hallucinate.md schema=silver-ablation/1 -->
---
type: source
created: 2026-05-27
...
- **Core formal objects:** the Is-It-Valid (IIV) binary-classification problem (/50 mixture of valid examples and uniformly random errors); the reduction theorem `err ≥ 2·err_iiv − |V|/|E| − δ` (Corollary 1, generalized with prompts in Theorem 1); the Arbitrary Facts model and singleton-rate bound (Theorem 2); the pure-multiple-choice bound (Theorem 3); the binary-grader optimality result (Observation 1). Full proofs in Appendices A–F.[^1]
