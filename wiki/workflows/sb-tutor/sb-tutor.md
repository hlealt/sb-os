...
2. If invoked to expand or enrich a library page (e.g. `/sb-tutor expand the item [X] of the topic [Y]`, or "enrich the topic Y") → follow `./library-protocol.md` ENRICH mode; do NOT start a new lesson
