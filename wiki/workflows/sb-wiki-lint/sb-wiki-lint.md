...
4. If a row already exists, preserve its `Wiki` value (`Yes`, `Partial`, `No`, `Duplicate (…)`, or `Original (twin: …)`) — EXCEPT the stale-`No` heal in item 6.
