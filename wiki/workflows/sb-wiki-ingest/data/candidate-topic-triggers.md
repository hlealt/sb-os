...
2. Add a `> [!warning] Disputed` callout to the affected concept/entity page (see `../shared/section-menus.md` for callout format).
...
When Contradiction fires `same-scope-opposing`, the agent ALSO adds a `> [!warning] Disputed` callout to the affected concept/entity page BEFORE the user promotes the candidate. Read `../shared/section-menus.md` for the exact callout format.
