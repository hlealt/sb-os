...
These hooks are user-managed. sb-os will never modify your `settings.json`. Re-run `python install.py --upgrade` after editing settings.json — the upgrade does not touch your hooks.
