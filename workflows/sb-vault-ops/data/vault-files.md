...
Daily notes have section-routing rules in `0-periodic-notes/daily/CLAUDE.md` when present. Templates ship with sb-os and live at `{sb_os_path}/templates/`. Daily notes are typically created by Obsidian's daily-notes plugin.
