...
| Disconfirm | Adversarial discovery wave | `disconfirm-wave.md` (dispatched by `research.md` Step 7a, `thesis.md` Step 2b, `review.md` Step 3b) | `thesis`/`review` DISPATCH `disconfirm-wave.md` directly; `research` dispatches it as part of its discovery pass; wave definition, interface contract, and B10 skeleton live in the file |
