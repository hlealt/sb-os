...
nextStep: {sb_os_path}/para/workflows/sb-onboarder/step-01-orient.md
---
...
1. Read `{sb_os_path}/para/workflows/sb-onboarder/data/concept-primer.md` — load teaching content.
2. Read `{sb_os_path}/para/workflows/sb-onboarder/data/life-domain-inspiration.md` — load curated examples.
3. Read `{sb_os_path}/para/workflows/sb-onboarder/data/concept-docs-map.md` — load the topic → doc map for the [?] help handler.
