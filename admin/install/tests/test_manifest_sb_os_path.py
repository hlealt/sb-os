...
Run with:
  python -m pytest 3-resources/tools/sb-os/admin/install/tests/test_manifest_sb_os_path.py -v
OR:
  python 3-resources/tools/sb-os/admin/install/tests/test_manifest_sb_os_path.py
...
# ---------------------------------------------------------------------------
# Import bootstrap — make ``admin.install.manifest`` importable regardless of
# the working directory from which the test is executed.
# ---------------------------------------------------------------------------

def _bootstrap() -> None:
    """Insert the sb-os repo root onto sys.path so imports resolve."""
    # This file lives at: <sb-os-repo>/admin/install/tests/test_manifest_sb_os_path.py
    # The repo root is three levels up.
    tests_dir = Path(__file__).resolve().parent
    install_dir = tests_dir.parent          # admin/install/
    admin_dir = install_dir.parent          # admin/
    repo_root = admin_dir.parent            # sb-os repo root
...
from admin.install import manifest  # noqa: E402  (after bootstrap)
